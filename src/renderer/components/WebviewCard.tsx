...
export default function WebviewCard({ card }: WebviewCardProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="flex items-center gap-2 px-3 py-2 cursor-grab active:cursor-grabbing select-none border-b border-cyan-500/20"
      ...
      <div className="px-3 py-1 bg-black/30 border-b border-white/5">
        <span className="text-[10px] text-gray-500 font-mono select-text">{displayUrl}</span>
      </div>
      ...
      <div className="flex-1 relative overflow-hidden min-h-0">
        {/* Loading overlay */}
        {isLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-[#16161e] z-10">
        ...
        {hasFailed && !isLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-[#16161e] z-10">
            <div className="flex flex-col items-center gap-3 text-center px-4">
              <span className="text-sm text-gray-400">Failed to load this page</span>
              <span className="text-xs text-gray-600">This site may block embedding</span>
              <button
